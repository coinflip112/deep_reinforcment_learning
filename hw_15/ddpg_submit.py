...
if __name__ == "__main__":
    ...
    network._target_actor = tf.keras.models.load_model(
        Path(model_dir, "target_actor.h5")
    )
    network._critic = tf.keras.models.load_model(Path(model_dir, "critic.h5"))
    network._target_critic = tf.keras.models.load_model(
        Path(model_dir, "target_critic.h5")
    )
